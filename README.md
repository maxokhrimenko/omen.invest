...
> **🚀 Version 4.5.0 - Portfolio Dividend Metrics & Frontend Chart Enhancement**: This release introduces comprehensive portfolio-level dividend metrics and completes the CLI-frontend alignment, ensuring consistent behavior across all interfaces with enhanced visual presentation and custom chart legends.
