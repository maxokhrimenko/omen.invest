...
Usage:
    python admin/clear_warehouse.py --help
    python admin/clear_warehouse.py --clear-all
    python admin/clear_warehouse.py --clear-ticker AAPL
    python admin/clear_warehouse.py --stats
    python admin/clear_warehouse.py --backup-and-clear
    python admin/clear_warehouse.py --reset-metrics
"""
...
class WarehouseClearManager:
    ...
    def __init__(self, warehouse_db_path: str = "./warehouse/warehouse.sqlite"):
...
Examples:
  ...
  python admin/clear_warehouse.py --clear-ticker AAPL
  python admin/clear_warehouse.py --backup-and-clear
  python admin/clear_warehouse.py --restore warehouse_backup_20241201_143022.sqlite
        """
    )
    ...
    parser.add_argument(
        "--warehouse-path", 
        type=str, 
        default="./warehouse/warehouse.sqlite",
        help="Path to warehouse database file (default: ./warehouse/warehouse.sqlite)"
    )
